...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _dom_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom.js */ \"./src/dom.js\");\n/* harmony import */ var _leaderboardAPI_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./leaderboardAPI.js */ \"./src/leaderboardAPI.js\");\n\n\n\n\nconst url = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/QzGv34LB2uIZhM79CnAe/scores';\n\nconst createList = async () => {\n  let scores = [];\n  await (0,_leaderboardAPI_js__WEBPACK_IMPORTED_MODULE_2__.getData)(url).then((data) => { scores = data.result; });\n  (0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.populateList)(scores);\n};\n\nconst addScore = () => {\n  const score = (0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.getNewScore)();\n  (0,_leaderboardAPI_js__WEBPACK_IMPORTED_MODULE_2__.sendData)(url, score);\n};\n\nconst refreshList = () => {\n  (0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.clearList)();\n  createList();\n};\n\ncreateList();\n\nconst submit = document.querySelector('#submit-btn');\nsubmit.addEventListener('click', addScore);\n\nconst refresh = document.querySelector('#refresh-btn');\nrefresh.addEventListener('click', refreshList);\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getData\": () => (/* binding */ getData),\n/* harmony export */   \"sendData\": () => (/* binding */ sendData)\n/* harmony export */ });\nconst getData = async (url) => {\n  try {\n    const data = await fetch(url, {\n      method: 'GET',\n      headers: {\n        Accept: 'application/json',\n        'Content-type': 'application/json',\n      },\n    });\n    return data.json();\n  } catch (err) {\n    throw new Error(err);\n  }\n};\n\nconst sendData = async (url, score) => {\n  try {\n    await fetch(url, {\n      method: 'POST',\n      headers: {\n        Accept: 'application/json',\n        'Content-type': 'application/json',\n      },\n      body: JSON.stringify(score),\n    });\n  } catch (err) {\n    throw new Error(err);\n  }\n};\n\n//# sourceURL=webpack://leaderboard/./src/leaderboardAPI.js?");
